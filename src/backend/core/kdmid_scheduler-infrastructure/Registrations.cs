...
public static class Registrations
{
    ...
    public static IServiceCollection AddKdmidAzureInfrastructure(this IServiceCollection services) => services
        ...
        .AddScoped<AzureTableWriterRepository<PersistenceInfrastructure.AzureTable.Contexts.KdmidPersistenceContext, PersistenceModels.AzureTable.v1.KdmidAvailableDates>>()
    ...
    public static IServiceCollection AddKdmidVpsInfrastructure(this IServiceCollection services) => services
        ...
        .AddScoped<MongoDbReaderRepository<PersistenceInfrastructure.MongoDb.Contexts.KdmidPersistenceContext, PersistenceModels.MongoDb.v1.KdmidAvailableDates>>()
