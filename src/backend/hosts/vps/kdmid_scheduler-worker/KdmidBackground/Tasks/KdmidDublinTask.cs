...
public sealed class KdmidDublinTask(
    ILogger<KdmidDublinTask> logger,
...
{
    public const string Name = "Dublin";

    protected override Expression<Func<KdmidAvailableDates, bool>> DataFilter => x => x.City.Code == "dublin";
}
