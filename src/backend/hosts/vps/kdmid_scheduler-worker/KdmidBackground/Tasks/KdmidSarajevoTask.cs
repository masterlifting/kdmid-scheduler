...
public sealed class KdmidSarajevoTask(
    ILogger<KdmidSarajevoTask> logger,
...
{
    public const string Name = "Sarajevo";

    protected override Expression<Func<KdmidAvailableDates, bool>> DataFilter => x => x.City.Code == "sarajevo";
}
