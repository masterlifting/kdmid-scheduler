...
public sealed class KdmidHelsinkiTask(
    ILogger<KdmidHelsinkiTask> logger,
...
{
    public const string Name = "Helsinki";

    protected override Expression<Func<KdmidAvailableDates, bool>> DataFilter => x => x.City.Code == "helsinki";
}
