...
public sealed class KdmidLjubljanaTask(
    ILogger<KdmidLjubljanaTask> logger,
...
{
    public const string Name = "Ljubljana";

    protected override Expression<Func<KdmidAvailableDates, bool>> DataFilter => x => x.City.Code == "ljubljana";
}
