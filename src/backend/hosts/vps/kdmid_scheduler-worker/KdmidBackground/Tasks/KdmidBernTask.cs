...
public sealed class KdmidBernTask(
    ILogger<KdmidBernTask> logger,
...
{
    public const string Name = "Bern";

    protected override Expression<Func<KdmidAvailableDates, bool>> DataFilter => x => x.City.Code == "bern";
}
